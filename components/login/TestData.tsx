...
//   const { email, password, loading, remember_me, errors } = useSelector(login_form_state_to_props, shallowEqual);
  ...
  return (
    <div>
      <p>Test data</p>
      <Dropdown value={valueOne} options={cities} onChange={onValueChange} optionLabel="name" placeholder="Select a data" />
